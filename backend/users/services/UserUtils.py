...
class UserUtils:
    ...
    @classmethod
    def get_profle_meta_details(cls, meta_data, social_id=None, social_platform=None, user_info=None):
        profile = {
    ...
    @classmethod
    def verify_google_details(cls, access_token):
