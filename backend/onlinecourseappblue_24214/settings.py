...
# Stripe
STRIPE_TEST_PUBLIC_KEY = env.str("STRIPE_TEST_PUBLIC_KEY", "pk_test_51IDYlIJH3WYajMEihaDMbt0NvORXKjm1fOXxABCwt78QlsbItdctUq7WHCUreVar6M8Y63wAsHdGvEigUY4nss9Z00x7RVYzXZ")
STRIPE_TEST_SECRET_KEY = env.str("STRIPE_TEST_SECRET_KEY", "sk_test_51IDYlIJH3WYajMEieuEIZpSCYEhzKfGBL2PRcpEkAx33fW1B6rKwtcXZyp7hN9HJbCTiywDmy4m197kGu3k89dvQ009ePekfOW")
STRIPE_API_KEY = env.str('STRIPE_API_KEY', "")
STRIPE_LIVE_PUBLIC_KEY = env.str("STRIPE_LIVE_PUBLIC_KEY", "pk_test_51IDYlIJH3WYajMEihaDMbt0NvORXKjm1fOXxABCwt78QlsbItdctUq7WHCUreVar6M8Y63wAsHdGvEigUY4nss9Z00x7RVYzXZ")
STRIPE_LIVE_SECRET_KEY = env.str("STRIPE_LIVE_SECRET_KEY", "sk_test_51IDYlIJH3WYajMEieuEIZpSCYEhzKfGBL2PRcpEkAx33fW1B6rKwtcXZyp7hN9HJbCTiywDmy4m197kGu3k89dvQ009ePekfOW")
STRIPE_LIVE_MODE = env.bool("STRIPE_LIVE_MODE", False)
DJSTRIPE_WEBHOOK_SECRET = env.str("DJSTRIPE_WEBHOOK_SECRET", "whsec_KWpopj1QvhhiYOanRaS1d6BUaHa4JVku")  # Get it from the section in the Stripe dashboard where you added the webhook endpoint
DJSTRIPE_FOREIGN_KEY_TO_FIELD = "id"


SENDGRID_SANDBOX_MODE_IN_DEBUG=1
